              ...
              <div className="col-sm-4 col-md-4 col-lg-4 filter-options">
                ...
                <div id="filter" className="collapse show">
                  ...
                  <div>
                    <input
                      type="checkbox"
                      onChange={() => this.handleModelChange(1)}
                    />
                  ...
                  <div style={{ display: "block" }}>
                    <input
                      type="checkbox"
                      onChange={() => this.handleModelChange(2)}
                    />
                  ...
                  <div>
                    <input
                      type="checkbox"
                      onChange={() => this.handleModelChange(3)}
                    />
                  ...
                  <div>
                    <input
                      type="checkbox"
                      onChange={() => this.handleModelChange(4)}
                    />
                  ...
                  <div>
                    <input
                      type="checkbox"
                      onChange={() => this.handleModelChange(5)}
                    />
